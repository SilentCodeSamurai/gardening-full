			...
			<PageContent className="flex flex-col gap-8 overflow-y-auto pb-6">
				<div className="space-y-4">
					<div className="flex flex-wrap gap-2">
						...
						>
							{m["components.locationLayoutEditor.openLayoutEditor"]()}
						</Link>
					</div>
						...
						<dl className="grid gap-x-4 gap-y-3 text-sm sm:grid-cols-[minmax(9rem,auto)_1fr]">
							<div className="contents">
								<dt className="text-muted-foreground">
									{m["components.detail.field.parentLocation"]()}
								</dt>
								<dd className="wrap-break-word min-w-0">
									<span className="text-muted-foreground">
										{m["components.detail.field.rootLocation"]()}
									</span>
								</dd>
							</div>
							<div className="contents">
								<dt className="text-muted-foreground">{m["components.detail.field.layoutFrame"]()}</dt>
								<dd className="wrap-break-word min-w-0">
									<span className="text-muted-foreground">
							...
							<div className="contents">
								<dt className="text-muted-foreground">{m["components.detail.field.recordId"]()}</dt>
								<dd className="wrap-break-word min-w-0">
