...
const cardVariants = cva(
	"group/card flex flex-col gap-4 overflow-hidden rounded-lg bg-card py-2 text-xs/relaxed text-card-foreground ring-1 ring-foreground/10 has-[>img:first-child]:pt-0 data-[size=sm]:gap-3 data-[size=sm]:py-2 *:[img:first-child]:rounded-t-lg *:[img:last-child]:rounded-b-lg",
	{
		variants: {
			size: {
				default: "py-2 px-2",
			...
			type: {
				...
				item: "bg-card/30 shadow-sm hover:bg-card/60 py-1",
			},
		},
		defaultVariants: {
			size: "default",
